...
class GeneradorHistorico:
    ...
    def generar_sql(self):
        ...
        with open(OUTPUT_FILE, 'w', encoding='utf-8') as f:
            ...
            # Actualización de empleados y descuentos (Nuevos campos)
            f.write("\n-- ACTUALIZANDO EMPLEADOS Y DESCUENTOS --\n")
            all_empleados = []
            for emps in self.empleados_por_sucursal.values(): all_empleados.extend(emps)
            ...
            while fecha_actual <= FECHA_FIN:
                ...
                for suc_id in self.ids_sucursales:
                    ...
                    for _ in range(random.randint(1, 2)):
                        ...
                        f.write(f"INSERT INTO sesion (sesion_id, empleado_id, dispositivo_id, fecha_hora_apertura, efectivo_inicial, estado) VALUES ({ses_id}, {emp}, {dev}, '{inicio}', {caja}, 'cerrada');\n")
